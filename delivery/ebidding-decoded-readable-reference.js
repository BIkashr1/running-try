...
async function waitForBiddingWindow() {
  const _0x199c6e = a0_0x5cae94,
    ...
    _0x1f62cc = convUtcToLocal(_0x2f3d3e["CurrDate"], _0x2f3d3e["CurrTime"]),
  ...
  if (_0x1f62cc === null || _0x410b38 === null || _0x325a48 === null) {
    ...
    else (_0x3aa064("All batches submitted!"), (_0x2211fb["completed"] = !![]));
  }
  ...
  function _0x3a884d() {
    ...
    return Date["now"]() + _0x7ca4f6;
  }
  if (_0x3a884d() >= _0x325a48)
    return (
      logWarn("Bidding window has already expired!"),
      { status: "expired" }
    );
  if (_0x3a884d() < _0x410b38) {
    ...
    while (_0x3a884d() < _0x410b38) {
          ...
          if (_0xf8d913 > 0x7530)
            ...
            if ("jduBd" !== "jduBd") {
              const _0x1b3c02 = _0x4942c6["find"](
                (_0x1350c0) =>
                  _0x1350c0["SapOrderId"] === _0x4169ae["SapOrderId"],
              );
              _0x1b3c02 &&
      ...
      _0xf8d913 <= 0xea60 &&
        ...
        ("gJXwH" !== "gJXwH"
          ...
          : (process["stdout"]["write"]("\x0a"),
            logInfo(
              "1 minute remaining! Re-logging in to ensure active session...",
            ),
            await login(),
            (_0x3aeaf8 = !![])));
      if (_0xf8d913 <= 0x1b58 && !_0x2203a2) {
        if ("kXOrq" !== "eIuEs")
          ...
          const _0x4f71b2 = _0x326fc8(_0x4a58f5["BiddingRank"] || "")
              ...
              ["replace"](/^0+/, ""),
            _0x3a519b =
              _0x4f71b2 === "1" || _0x5ace62(_0xd771d8["BiddingRank"]) === 0x1;
          _0x3a519b
            ? (_0x3ccf71++,
              _0x241e14(
                "🏆 RANK 1 ACHIEVED! -> City: " +
      ...
      if (_0xf8d913 <= 0xbb8 && !_0x4ff88e) {
        if ("Zdpdc" !== "Zdpdc") return;
        else {
          (process["stdout"]["write"]("\x0a"),
            logInfo(
              "Polling SAP for captcha availability (catching it as it opens)...",
            ));
          let _0x4bd4ab = 0x0;
          ...
          while (_0x3a884d() < _0x410b38) {
            ...
            if (_0x606ff7) {
              if ("JKvgR" === "tSMzs") {
                ...
                _0x32693a["response"]["status"] === 0x191 &&
                  _0x166ac5(
                    "Invalid credentials. Check USER_ID and PASSWORD in .env",
                  );
                if (_0x440c66["response"]["headers"]["x-csrf-token"])
                  return (
                    (_0x24527b =
                      _0x4abbb6["response"]["headers"]["x-csrf-token"]),
                    _0x469055(
      ...
      if (_0xf8d913 <= 0x32) await sleep(_0xf8d913);
        ...
        if (_0xf8d913 < 0xbb8) {
          if ("UagYL" === "UagYL") await sleep(0xa);
          else {
            if (!_0x5e25b8) return 0x0;
            const _0xa24d1c = _0x378710["match"](/PT(\d+)H(\d+)M(\d+)S/);
            if (_0xa24d1c)
              return (
...
async function runSingleCycle() {
    ...
    if ("fRHgp" === "iQLCb") {
      const _0x3780b0 =
        ...
        _0x1a4b95["response"]["data"]["error"]
          ? _0x77738b["response"]["data"]["error"]["message"]["value"]
          : _0x2c966e["message"];
      return (
        _0x108dbc("Strategy [" + _0x32e03d + "] HTTP error: " + _0x3780b0),
        { type: "E", message: _0x3780b0 }
      );
    } else {
      (logErr("Login failed. Retrying in 10s..."), await sleep(0x2710));
      return;
    }
  }
  const _0x4d6fea = await fetchBidOrderList();
  if (!_0x4d6fea) {
    if ("oloXL" === "iaXqt") _0x319ff7["pendingBatches"]["push"](_0x2b7e38);
    else {
      (logErr(
  ...
  if (!_0x3cf154) {
    if ("ebnaO" === "ebnaO") {
      ...
      if (_0xf22a6["hasOwnProperty"]("BIDING\x20AMMOUNT"))
  ...
  if (_0xd17c61["status"] === "expired") {
    if ("xtBcZ" !== "xtBcZ")
      _0x41c963(
        "SAP Error: " +
          _0x54743f["response"]["data"]["error"]["message"]["value"],
      );
    else {
      logWarn(
        "Bidding window expired or not open yet. Monitoring for next slot...",
      );
  ...
  if (CONFIG["DRY_RUN"]) {
    if ("BAjXF" === "kyKTK")
      (_0x454636["DestCityDesc"] || "")["trim"]() === _0x2a7229 &&
        (_0x1a6c0e["Spi"] || "")["trim"]() === _0x4e3684 &&
        ((_0x4867dd["BiddingAmount"] = _0x933879(_0x182437)["toFixed"]()),
        (_0x2d68ab["AvgWtBidAmount"] = _0x5b5afa(_0x13cd3f)["toFixed"]()));
    else {
      ...
      (_0x5a0173
        ? "MYLcA" === "ZkZkf"
          ...
          : logOk('Captcha solved successfully: "' + _0x5a0173 + "\x22")
        : logWarn(
  ...
  hasActiveCsvBatch()
    ...
    : _0x52c784 && !csvBatchState["completed"]
      ...
      : "PjYmP" !== "PjYmP"
        ? _0x5b4506('Captcha solved successfully: "' + _0x599e4b + "\x22")
        : logInfo(
            "Skipping submission — all rows already submitted or no matching rows in CSV.",
          );
  (logInfo(
    "Re-fetching orders & vendor rankings in parallel to confirm status...",
  ),
  ...
  const _0x4e2444 = bidRows["filter"](
    ...
    _0x1eab5e =
      _0x4e2444["length"] > 0x0
        ? _0x4e2444
        : bidRows["filter"](
            (_0x2c8443) => Number(_0x2c8443["BiddingAmount"]) > 0x0,
          );
  if (_0x1eab5e["length"] > 0x0) {
    let _0x1eee1f = 0x0;
    (console["log"]("\x0a" + "═"["repeat"](0x32)),
      console["log"](
        "" +
          LOG_COLORS["bright"] +
          LOG_COLORS["cyan"] +
      ...
      console["log"]("═"["repeat"](0x32)),
      _0x1eab5e["forEach"]((_0x13b91a) => {
        const _0x2909f8 = _0x4d2bd7;
        if ("vFqVQ" !== "vFqVQ") {
          const _0x59ebdf = _0x4d0db1["parse"](
            _0x3d2960["readFileSync"](_0x1fcbaf, "utf-8"),
          );
          let _0x258c2e = 0x0;
          (_0x59ebdf["forEach"](({ hash: _0x13a5d4, result: _0xa85fdc }) => {
            _0x13a5d4 &&
              _0xa85fdc &&
          ...
          const _0x2686e0 = String(_0x13b91a["BiddingRank"] || "")
              ["trim"]()
              ["replace"](/^0+/, ""),
            _0x22d69f =
              _0x2686e0 === "1" || Number(_0x13b91a["BiddingRank"]) === 0x1;
          _0x22d69f
            ? (_0x1eee1f++,
              logBold(
                "🏆 RANK 1 ACHIEVED! -> City: " +
                  _0x13b91a["DestCityDesc"] +
                  ", SPI: " +
                  _0x13b91a["Spi"] +
                  ", Bid: " +
                  _0x13b91a["BiddingAmount"],
              ))
            : "atzUq" !== "XyBgY"
              ? logWarn(
                  "📉 Rank " +
                    ...
                    _0x13b91a["BiddingAmount"] +
                    " (L1 is " +
                    _0x13b91a["L1BidAmount"] +
                    ")",
                )
              : (_0x2d8c0(
                  "Delete CSV not found: " +
                    _0x57e300 +
...
async function main() {
  ...
  do {
    ...
    typeof _0x4915ea === "string" && (_0x4915ea = { status: _0x4915ea });
      ...
      if (
        ...
        "EUiTU" === "fXOTy"
          ? (_0x3b2ed3 &&
            ...
            (_0x48a5b0 = {
              submittedKeys: (_0x2dffb6 && _0x3486b5["submittedKeys"]) || {},
              activeKeys: [],
              pendingBatches: [],
              groupsByKey: {},
              autoRunning: ![],
        ...
        if ("kdebB" !== "FDgUA") {
          if (_0x4915ea["status"] === "active" && _0x4915ea["endTime"]) {
            const _0x29a29b = Date["now"]() + (_0x4915ea["clockOffset"] || 0x0),
            ...
            _0x4b835d > 0x0
              ...
              : (logInfo(
                  "Waiting for next slot to be published (polling in 15s)...",
                ),
                await sleep(0x3a98));
          } else
            "gwHlH" === "Srvxl"
          ...
          return (
            (_0x2a57a9 = _0xe7a89c["response"]["headers"]["x-csrf-token"]),
            _0x2af7e9(
              "Got CSRF token despite error: " +
                _0x32d95f["substring"](0x0, 0xc) +
                "...",
            ),
            !![]
          );
